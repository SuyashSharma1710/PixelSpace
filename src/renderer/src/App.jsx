                ...
                <div className="panel-body-right">
                  ...
                  {isProcessing && progress && (
                    <div style={{ marginTop: 'var(--space-xs)' }}>
                      <div style={{ height: '6px', borderRadius: '99px', background: 'var(--panel-border)', overflow: 'hidden' }}>
                        <div style={{
                          height: '100%',
                          borderRadius: '99px',
                      ...
                      <p className="eyebrow" style={{ marginTop: 'var(--space-xs)', color: 'var(--text-muted)', textTransform: 'none', letterSpacing: 'normal' }}>
